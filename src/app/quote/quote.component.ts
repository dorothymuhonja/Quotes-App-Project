...
export class QuoteComponent implements OnInit {
 ...
 new Quote (3,`We are what we repeatedly do. Excellence therefore is not an act but a habit`, `Aristotle`,`Dorothy Muhonja`, new Date(2021,2,1),0,0),
 ...
 new Quote (5, `You either die a hero or you live long enough to see yourself become a villain`, `From Batman The Dark Knight`, `Dorothy Muhonja`, new Date(2021, 1, 29 ),0,0),
];
// adding a new quote
addNewQuote(quote){
